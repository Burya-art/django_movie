# Generated by Django 5.1.7 on 2025-04-03 07:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=2019, verbose_name='Дата випуску')),
                ('country', models.CharField(max_length=30, verbose_name='Країна')),
                ('world_premiere', models.DateField(default=datetime.date.today, verbose_name="Світова прем'єра")),
                ('budget', models.PositiveIntegerField(default=0, help_text='сумма в $', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='сумма в $', verbose_name='Збори в США')),
                ('fees_in_world', models.PositiveIntegerField(default=0, help_text='сумма в $', verbose_name='Збори в світі')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.ratingstar', verbose_name='зірки')),
            ],
            options={
